...
<html>
	...
	<body>
		...
		<div class="topnav" id="myTopnav">
			...
			<a href="#shoe"  class="active">Shoes</a>
		...
		<div class="cloth-banner">
			<img src="shoe.jpg" alt="cloth banner">
		</div>
		<div class="main">
			<ul class="product-grid">
			<?php
			$sql="SELECT * FROM product WHERE cat='shoe' ORDER BY p_id";
			$res=mysqli_query($db,$sql);
			if(mysqli_num_rows($res)>0){
				while($row=mysqli_fetch_array($res)){
			?>
				<li class="prod">
				<form method="post" action="shoe.php?action=add&id=<?php echo $row["p_id"]; ?>"> 
					<img src="<?php echo $row["pimg"]; ?>" alt="shoe1" class="pic">
					<div class="desc">
